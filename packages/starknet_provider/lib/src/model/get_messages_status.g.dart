...
GetMessagesStatusResult _$GetMessagesStatusResultFromJson(
        Map<String, dynamic> json) =>
...
Map<String, dynamic> _$GetMessagesStatusResultToJson(
        GetMessagesStatusResult instance) =>
    <String, dynamic>{
      'result': instance.result.map((e) => e.toJson()).toList(),
      'starkNetRuntimeTypeToRemove': instance.$type,
    };

GetMessagesStatusError _$GetMessagesStatusErrorFromJson(
        Map<String, dynamic> json) =>
...
Map<String, dynamic> _$GetMessagesStatusErrorToJson(
        GetMessagesStatusError instance) =>
    <String, dynamic>{
