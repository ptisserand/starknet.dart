...
_OffChainSession _$OffChainSessionFromJson(Map<String, dynamic> json) =>
    _OffChainSession(
...
Map<String, dynamic> _$OffChainSessionToJson(_OffChainSession instance) =>
    <String, dynamic>{
...
_OnChainSession _$OnChainSessionFromJson(Map<String, dynamic> json) =>
    _OnChainSession(
...
Map<String, dynamic> _$OnChainSessionToJson(_OnChainSession instance) =>
    <String, dynamic>{
